...
import os 
import sys
sys.path.append(r"F:\Upright_Solution\arabic_dilect\klaam")
...
def main():
    ...
    dataset=r"F:\Upright_Solution\arabic_dilect\dataset\train\wav\*\*.wav"
    path =r"F:\Upright_Solution\arabic_dilect\dataset\train\wav"
    train_dataset = datasets.load_dataset(path,data_files=dataset,split="train")
    eval_dataset = datasets.load_dataset(path,data_files=dataset,split="train")
